...
const buildingData = 

  {
    ...
    "name": "polygon",
    "features": [
    { "type": "Feature", "id": "ef6512f46485e27963c248bcc945c3db", "properties": { "level": 1, "name": "outer-walls", "height": 10, "base_height": 0, "color": "grey" }, "geometry": { "type": "Polygon", "coordinates":
      [ 
        [
